...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="F1Passport",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface ChoiceCountryViewController (SWIFT_EXTENSION(F1Passport)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC10F1Passport23DebugInfoViewController")
@interface DebugInfoViewController : TableViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10F1Passport24DeviceListViewController")
...
@interface DeviceListViewController (SWIFT_EXTENSION(F1Passport)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC10F1Passport35F1AccountSdkNavgationViewController")
@interface F1AccountSdkNavgationViewController : UINavigationController
...
@interface F1AccountSdkNavgationViewController (SWIFT_EXTENSION(F1Passport)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC10F1Passport17KYCViewController")
...
SWIFT_CLASS("_TtC10F1Passport19LoginViewController")
...
SWIFT_CLASS("_TtC10F1Passport22UserInfoViewController")
@interface UserInfoViewController : TableViewController <UINavigationControllerDelegate>
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
