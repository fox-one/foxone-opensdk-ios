...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="F1Exchange",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10F1Exchange15CurrencyManager")
...
SWIFT_CLASS("_TtC10F1Exchange21DepositViewController")
@interface DepositViewController : StackViewController <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC10F1Exchange30F1exSdkNavgationViewController")
@interface F1exSdkNavgationViewController : UINavigationController
...
@interface F1exSdkNavgationViewController (SWIFT_EXTENSION(F1Exchange)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC10F1Exchange22FavoriteViewController")
...
@interface FavoriteViewController (SWIFT_EXTENSION(F1Exchange)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC10F1Exchange23HalfTableViewController")
@interface HalfTableViewController : UIViewController <DeckTransitionViewControllerProtocol, UITableViewDelegate>
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC10F1Exchange22MyOrdersViewController")
@interface MyOrdersViewController : UIViewController <UINavigationControllerDelegate>
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@class FoxScrollContentView;

@interface MyOrdersViewController (SWIFT_EXTENSION(F1Exchange)) <FoxScrollContentViewDelegate>
...
@interface QuotationViewController (SWIFT_EXTENSION(F1Exchange)) <FoxScrollContentViewDelegate>
- (void)scrollContentViewWithScrollContentView:(FoxScrollContentView * _Nonnull)scrollContentView startIndex:(NSInteger)startIndex endIndex:(NSInteger)endIndex;
...
SWIFT_CLASS("_TtC10F1Exchange13TradeServices")
@interface TradeServices : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface WalletViewController (SWIFT_EXTENSION(F1Exchange)) <UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC10F1Exchange22WithdrawViewController")
@interface WithdrawViewController : StackViewController <UINavigationControllerDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
