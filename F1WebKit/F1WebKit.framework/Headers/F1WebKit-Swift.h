...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="F1WebKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8F1WebKit24WebBrowserViewController")
...
@interface WebBrowserViewController (SWIFT_EXTENSION(F1WebKit)) <WKUIDelegate>
